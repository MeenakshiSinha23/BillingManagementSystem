...
Bill addItem(Bill b){
    ...
    while(!close){
        ...
        if(choice==1){
            ...
            cin>>item;//cant use member variable directly so we r taking get wala item
      b.setItem(item);//taken from getter and setter
    ...
    system("cls");
    close=true;//while loop terminate
                ...
                while(getline(in,line)){
                 ...
                 if(item==itemName){
                    ...
                    if(quant<=itemQuant){
                        ...
                        // not quantity
                        cout<<"\t Sorry, "<<item<<" Ended"<<endl;//when quantity is not avaible
